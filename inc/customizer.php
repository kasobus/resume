<?php
/**
 * Resume for Success Theme Customizer
 *
...
function resume_customize_preview_js() {
	wp_enqueue_script( 'resume-customizer', get_template_directory_uri() . '/dist/customizer.js', array( 'customize-preview' ), '20151215', true );
}
